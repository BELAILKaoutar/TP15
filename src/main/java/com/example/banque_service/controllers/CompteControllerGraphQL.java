...
import com.example.banque_service.dto.Stats;
...
public class CompteControllerGraphQL {
    ...
    public TransactionStats transactionStats() {
        ...
        double sumDepots = transactionRepository.sumByType(com.example.banque_service.entities.TypeTransaction.DEPOT);
        double sumRetraits = transactionRepository.sumByType(com.example.banque_service.entities.TypeTransaction.RETRAIT);
